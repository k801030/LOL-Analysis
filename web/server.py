...
from app.helpers import aggregate_win_rate, aggregate_win_rate_by_lane
...
def index():
    ...
    lane_win_rate = [win_rate.to_html_dict() for win_rate in aggregate_win_rate_by_lane(win_rate_map).values()]
